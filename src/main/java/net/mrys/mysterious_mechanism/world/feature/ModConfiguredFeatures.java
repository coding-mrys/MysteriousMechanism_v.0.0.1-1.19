...
public class ModConfiguredFeatures {
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> OVERWORLD_MRYS_ORES = Suppliers.memoize(() -> List.of(
            OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, ModBlocks.MRYS_ORE.get().defaultBlockState()),
            OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, ModBlocks.MRYS_BLOCK.get().defaultBlockState())));

    public static final RegistryObject<ConfiguredFeature<?, ?>> MRYS_ORE = CONFIGURED_FEATURES.register("mrys_ore",
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(OVERWORLD_MRYS_ORES.get(),20)));
