...
public class ModConfiguredFeatures {
    ...
    public static final Supplier<List<OreConfiguration.TargetBlockState>> OVERWORLD_MRYS_ORES = Suppliers.memoize(() -> List.of(
            ...
            OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, ModBlocks.MRYS_CRYSTAL.get().defaultBlockState()),

            OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, ModBlocks.MRYS_CRYSTAL.get().defaultBlockState()),
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> MRYS_CRYSTAL = CONFIGURED_FEATURES.register("mrys_crystal",
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(OVERWORLD_MRYS_ORES.get(),7)));
